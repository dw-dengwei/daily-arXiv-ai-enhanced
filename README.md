...
5. GitHub Pages authentication is only a client-side UI gate; the public `data` branch remains directly readable. Do not use it for private data.
...
9. You can manually click **Run workflow** to test if it works well (it may take about one hour). By default, this action runs on weekdays; you can modify it in `.github/workflows/run.yml`.
